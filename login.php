...
if(!$conn)
{
 ...
 if(isset($_POST['log']))
 {
  ...
  $pass=$_POST['password'];
  $check=mysqli_query($conn,"select * from employee_login where email='$em' && password='$pass'");

  $sel_id=mysqli_query($conn,"select employee_id from employee_login where email='$em' && password='$pass'");
